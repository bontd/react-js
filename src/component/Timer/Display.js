                ...
                <div className="display">
                    <div>
                        ...
                        <div className="input-group input-group-lg display-input-group">
                            <input type="text" className="from-control display-time display-hours" maxLength="2" placoholder="00"
                            ...
                            <input type="text" className="from-control display-time display-minutes" maxLength="2" placoholder="00"
